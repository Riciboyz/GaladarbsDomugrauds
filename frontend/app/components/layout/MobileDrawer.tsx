  ...
  return (
    <>
      <div
        onClick={onClose}
        aria-hidden="true"
        className={`lg:hidden fixed inset-0 bg-black/50 backdrop-blur-[2px] z-40 transition-opacity duration-300 ${
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between px-5 h-14 border-b border-border-ui">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center shadow-sm">
                <ChatBubbleLeftRightIcon className="w-[18px] h-[18px] text-accent-fg" />
              </div>
          ...
          <div className="px-5 py-5 border-b border-border-ui">
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3">
            <p className="px-3 pt-1 pb-2 text-[11px] font-semibold uppercase tracking-wider text-ink-muted/70">
              Konts
            </p>
            ...
            {(user as any)?.role === 'admin' && (
              <a
                href="/admin"
                onClick={onClose}
                className="w-full flex items-center gap-3 px-3 h-12 rounded-xl text-accent hover:bg-accent/10 active:bg-accent/15 transition-colors"
              >
            ...
            <div className="mt-4 pt-4 border-t border-border-ui">
              <p className="px-3 pb-3 text-[11px] font-semibold uppercase tracking-wider text-ink-muted/70">
                Izskats
              </p>
              <div className="px-1">
                <ThemePicker />
          ...
          <div className="px-3 py-3 border-t border-border-ui">
            <button
              onClick={handleLogout}
              className="w-full flex items-center gap-3 px-3 h-12 rounded-xl text-red-500 hover:bg-red-500/10 active:bg-red-500/15 transition-colors"
            >
