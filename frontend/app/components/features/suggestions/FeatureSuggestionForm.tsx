  ...
  return (
    ...
    >
      ...
      <input
        ...
        maxLength={INPUT_LIMITS.featureSuggestionTitle}
      ...
      <p className="text-xs text-ink-muted text-right -mt-1">
        {remainingChars(INPUT_LIMITS.featureSuggestionTitle, title)} simboli atlikuši
      </p>
      ...
      <textarea
        ...
        rows={4}
        maxLength={INPUT_LIMITS.featureSuggestionDescription}
      ...
      />
      <p className="text-xs text-ink-muted text-right -mt-1">
        {remainingChars(INPUT_LIMITS.featureSuggestionDescription, description)} simboli atlikuši
      </p>
