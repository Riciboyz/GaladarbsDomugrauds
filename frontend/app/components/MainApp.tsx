...
import Feed from './legacy/Feed'
import Profile from './legacy/Profile'
import RealtimeNotificationsProvider from './legacy/RealtimeNotificationsProvider'
// import Settings from './Settings' // Temporarily disabled
import Search from './legacy/Search'
import Groups from './legacy/Groups'
import RightSidebar from './legacy/RightSidebar'
import DailyTopicBanner from './legacy/DailyTopicBanner'
import TopicSubmission from './legacy/TopicSubmission'
import KeyboardShortcuts from './legacy/KeyboardShortcuts'
import SimpleCreateThread from './legacy/SimpleCreateThread'
import QuickSearchBar from './legacy/QuickSearchBar'
import { 
  HomeIcon, 
  UserIcon, 
  BellIcon,
